...
describe("DFS", function () {
    it("return an array of the nodes searched using DFS", function () {
        ...
        var validResult =
            result ===
            JSON.stringify([S.value, U.value, V.value, W.value, T.value, R.value, Q.value, Y.value, X.value, P.value]) ||
            result ===
            JSON.stringify([S.value, P.value, X.value, U.value, V.value, W.value, Y.value, R.value, Q.value, T.value]);
